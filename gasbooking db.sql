...
-- Insert data for table `consumer_detail`
...
-- Insert data for table `distributor_detail`
...
-- Insert data for table `feedback_complain`
...
-- Insert data for table `order_detail`
